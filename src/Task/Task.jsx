    ...
    return (
        <div className="p-5">
            <div>
                ...
                <div className={visible ? "bg-black/30 backdrop-blur-sm absolute bottom-0 top-0 right-0 left-0 grid place-items-center px-5 " : "hidden"}>
                        ...
                        <ul className=" mt-2 *:mt-2 text-ellipsis whitespace-nowrap overflow-scroll h-44">
                            {
                                data.map((user,index) =>
                                    <li key={index} className=" bg-blue-100 flex justify-between items-center px-3 py-2 rounded-md">
                                        ...
                                        <input  className=" bg-white rounded-md input-xs w-28"  name={`${user.user_name}assignedDate`} type="date" />
                                    </li>)
                            }
